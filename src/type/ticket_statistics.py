...
class TicketStatistics(object):
    def __init__(self, pending: int, unredeemed: int, unredeemedValue: int, redeemed: int, redeemedValue: int,
                 losingTickets: int, winProportion: int, neglected: int, rejected: int, rejectedValue: str) -> None:
